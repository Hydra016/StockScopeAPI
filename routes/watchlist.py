...
def delete_watchlist(watchlist_id: int,  user =  Depends(is_authenticated), db = Depends(get_db)):
...
def delete_watchlist_item(watchlist_id: int, watchlist_item_id: int,  user =  Depends(is_authenticated), db = Depends(get_db)):
